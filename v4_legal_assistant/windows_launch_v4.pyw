...
def main() -> int:
    ...
    if not VENV_PYTHON.exists():
        show_message(
            "Whisper Voice To Form V4 setup required",
            "The V4 Python environment was not found.\n\nRun install_windows_v4.bat first, then launch the app again.",
            0x10,
        )
        return 1
    ...
    try:
        from app_v4 import main as app_main

        app_main()
        return 0
    except Exception:
        show_message(
            "Whisper Voice To Form V4 launch failed",
            "Whisper Voice To Form V4 could not start.\n\n"
            "If you need startup details, run launch_windows_v4.bat from Command Prompt.\n\n"
