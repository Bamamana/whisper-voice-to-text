...
set "APP_DIR=%~dp0"
set "ISS_FILE=%APP_DIR%installer\WhisperVoiceToFormV3.iss"
set "ISCC_CMD="
...
:compile
echo Building V3 Windows installer...
"%ISCC_CMD%" "%ISS_FILE%"
if errorlevel 1 exit /b 1

echo.
echo V3 installer build complete.
echo Output folder:
echo   %APP_DIR%dist\windows-installer-v3
exit /b 0
