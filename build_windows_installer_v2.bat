...
set "APP_DIR=%~dp0"
set "ISS_FILE=%APP_DIR%installer\WhisperVoiceToFormV2.iss"
set "ISCC_CMD="
...
:compile
echo Building V2 Windows installer...
"%ISCC_CMD%" "%ISS_FILE%"
if errorlevel 1 exit /b 1

echo.
echo V2 installer build complete.
echo Output folder:
echo   %APP_DIR%dist\windows-installer-v2
exit /b 0
